    ...
    return (
        ...
        >
            <motion.button
                ...
                className="flex h-9 items-center border bg-white dark:bg-[#121212] px-3 text-sm font-medium outline-none text-black dark:text-white"
            >
                        ...
                        <AnimatePresence mode="popLayout">
                            {showSuccess ? (
                                ...
                                <motion.div
                                    ...
                                    className="h-full border bg-white dark:bg-[#121212] z-20 text-black dark:text-white"
                                >
                                    {openChild}
                                </motion.div>
                            )}
